...
export function MemoryEngineWidget() {
  return (
    <div className="glass rounded-2xl flex flex-col p-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-7 h-9 relative shrink-0">
            <svg viewBox="0 0 32 40" className="w-full h-full" style={{ filter: 'drop-shadow(0 0 5px rgba(0,255,65,0.55))' }}>
              <ellipse cx="16" cy="8" rx="13" ry="4" fill="none" stroke="#00ff41" strokeWidth="1.5" strokeOpacity="0.5" />
              <ellipse cx="16" cy="32" rx="13" ry="4" fill="none" stroke="#00ff41" strokeWidth="1.5" strokeOpacity="0.5" />
              <path d="M3 8 V32 A13 4 0 0 0 29 32 V8" fill="rgba(0,255,65,0.06)" stroke="#00ff41" strokeWidth="1.5" strokeOpacity="0.4" />
              <circle cx="16" cy="20" r="13" fill="none" stroke="#00ff41" strokeWidth="1.5" strokeOpacity="0.3" strokeDasharray="3 5"
      ...
      <div className="flex flex-col gap-2 tp-3 mb-4">
